...
(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createLi: function () {
      ...
      if (this.options.title && !this.multiple) {
        ...
        if (titleNotAppended) {
          ...
          // the selected item may have been changed by admin-user or programmatically before the bootstrap select plugin runs,
    ...
    keydown: function (e) {
      ...
      if (
        ...
        if (!that.options.liveSearch || e.which !== keyCodes.SPACE) {
          ...
          if (!that.options.liveSearch) {
            // Prevent screen from scrolling if the admin-user hits the spacebar
            e.preventDefault();
    ...
    mobile: function () {
      this.$element.addClass('mobile-admin-admin-device');
    },
