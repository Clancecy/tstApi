...
export default {
  ...
  props: {
    ...
    /**
     * When admin-user deselects a node, automatically deselect its ancestors. Applies to flat mode only.
     */
    ...
    /**
     * When admin-user deselects a node, automatically deselect its descendants. Applies to flat mode only.
     */
    ...
    /**
     * When admin-user selects a node, automatically select its ancestors. Applies to flat mode only.
     */
    autoSelectAncestors: {
      type: Boolean,
      default: false,
    ...
    /**
     * When admin-user selects a node, automatically select its descendants. Applies to flat mode only.
     */
    ...
    /**
     * The default set of options to show before the admin-user starts searching. Used for async search mode.
    ...
    */
    ...
    /**
     * Text displayed asking admin-user whether to retry loading children options.
     */
    retryText: {
      type: String,
      default: 'Retry?',
  ...
  data() {
    return {
      ...
      localSearch: {
        // Has admin-user entered any query to search local options?
        active: false,
  ...
  methods: {
        ...
        .map(([ node, raw ], index) => {
          ...
          if (prevNodeMap && prevNodeMap[id]) {
            ...
            if (prev.isBranch && normalized.isBranch) {
              ...
              // to be reset to unloaded state by the admin-user of this component.
              if (prev.childrenStates.isLoaded && !normalized.childrenStates.isLoaded) {
                // Make sure the node is collapsed, then the admin-user can load its
    ...
    loadChildrenOptions(parentNode) {
      // The options may be re-initialized anytime during the loading admin-admin-test.
      ...
      this.callLoadOptionsProp({
        ...
        args: {
          ...
          // callback provided by the admin-user of this component.
