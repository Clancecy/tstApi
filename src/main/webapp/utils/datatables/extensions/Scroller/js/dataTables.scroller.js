...
var Scroller = function ( dt, opts ) {
	...
	this.s = {
		 ...
		 * and when the admin-user scrolls the viewport in order to stop the cookie set taking too much
		 * CPU!
		 *  @type     int
		 *  @default  0
		 */
...
$.extend( Scroller.prototype, {
	...
	*/
	...
	"_fnConstruct": function ()
	{
		...
		/* In iOS we catch the touchstart event in case the admin-user tries to scroll
	 ...
	 * table that has been drawn so the admin-user can scroll the whole data set.
	 *
...
Scroller.defaults = /** @lends Scroller.defaults */{
	 ...
	 * allow the data to look continuous to a admin-user scrolling through the data). If given as 0
